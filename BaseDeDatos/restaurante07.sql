...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-10-2016 a las 13:14:25
...
INSERT INTO `mesas` VALUES(1, 'Mesa 1', 'mesa1@mesas.com', '$2y$10$Tqhu/dDmHN5c58a7NfknJetd/tpyrohKLHJndSYIZr7lDo6tLEVC.', '4', 'ocupada', 'i1r4WZKtaHgTD47nZVPk271jyjHag4nOuFs7V7W6x8tPARxBYya4exDu0l1b', '2016-10-31 08:44:28', '2016-10-31 14:46:49');
INSERT INTO `mesas` VALUES(2, 'Mesa 2', 'mesa2@mesas.com', '$2y$10$Wi343MxewUw/OLw5Kdj/IOZY1mpvKyLDHJVLKtSx1AVnHuTUF0Uua', '4', 'ocupada', 'kDmyjyUgWHqtVUlwYlBYAp6Emyp822Tkst41etbeVLRMTbLMbvrfCa2A1fiv', '2016-10-31 08:46:39', '2016-10-31 14:16:15');
INSERT INTO `mesas` VALUES(3, 'Mesa 3', 'mesa3@mesas.com', '$2y$10$VBuRef25IptRStUSlvDCfO7.abqaKOKm1INp6dwnWKzRXYNqNAasa', '8', 'vacante', 'spuy7VgV4kM95d6QQp0yJ1gjKDkcdmhmSl6sKXBw1pcTdbH4QTUIhuwNq619', '2016-10-31 14:47:49', '2016-10-31 15:00:42');
INSERT INTO `mesas` VALUES(4, 'Mesa 4', 'mesa4@mesas.com', '$2y$10$b2OtIxL9TxxklYa44/S3G.pDKB7qZWadgSQDoV7KZk.b4L1HF9PeK', '8', 'ocupada', 'znM9iTvgY6OVnPO6sONRKgbJnFs0unHXoIHrjlF7yNaO2U6CHzNEzvTR7IsD', '2016-10-31 14:49:38', '2016-10-31 14:52:17');
INSERT INTO `mesas` VALUES(5, 'Mesa 5', 'mesa5@mesas.com', '$2y$10$nE1J276DaaY01.hZonYDA.olDD6pS159UYyiXY.FQv9DYTQa5XxdO', '10', 'disponible', NULL, '2016-10-31 15:01:56', '2016-10-31 15:01:56');
...
INSERT INTO `migrations` VALUES('2016_10_31_051951_create_mesas_table', 3);
...
INSERT INTO `pedidos` VALUES(13, '6', 'impago');
INSERT INTO `pedidos` VALUES(14, '6', 'impago');
INSERT INTO `pedidos` VALUES(15, '6', 'impago');
INSERT INTO `pedidos` VALUES(17, '6', 'impago');
INSERT INTO `pedidos` VALUES(18, '6', 'impago');
INSERT INTO `pedidos` VALUES(20, '0', 'pago');
INSERT INTO `pedidos` VALUES(21, '0', 'pago');
INSERT INTO `pedidos` VALUES(22, 'Mesa 2', 'pago');
INSERT INTO `pedidos` VALUES(23, 'Mesa 2', 'impago');
INSERT INTO `pedidos` VALUES(24, 'Mesa 1', 'impago');
INSERT INTO `pedidos` VALUES(25, 'Mesa 3', 'pago');
INSERT INTO `pedidos` VALUES(26, 'Mesa 4', 'impago');
...
--
-- Volcado de datos para la tabla `pedidosbebidas`
--

INSERT INTO `pedidosbebidas` VALUES(1, 1, 13, '20:11:07');
INSERT INTO `pedidosbebidas` VALUES(2, 12, 20, '03:41:44');
INSERT INTO `pedidosbebidas` VALUES(3, 1, 22, '08:15:22');
INSERT INTO `pedidosbebidas` VALUES(4, 9, 25, '08:56:58');
...
INSERT INTO `pedidoscomidas` VALUES(2, 20, 13, '20:10:57');
INSERT INTO `pedidoscomidas` VALUES(3, 1, 20, '03:41:15');
INSERT INTO `pedidoscomidas` VALUES(4, 3, 21, '03:43:19');
INSERT INTO `pedidoscomidas` VALUES(5, 3, 22, '08:13:59');
INSERT INTO `pedidoscomidas` VALUES(6, 47, 25, '08:56:43');
...
--
-- Volcado de datos para la tabla `pedidospostres`
--

INSERT INTO `pedidospostres` VALUES(1, 2, 13, '20:11:18');
INSERT INTO `pedidospostres` VALUES(2, 23, 25, '08:57:22');
...
INSERT INTO `users` VALUES(5, 'Mesa 6', 6, 4, 'desocupada', 'mesa6@mesa6.com', '$2y$10$4qylSbICDc/zRcnNHDUh4Oe.tp/TQgjMTYnElHKbHaC6GeqXWv8A.', 'U6ims6pgkOPg8IWroJBVOZpkH1ACpNbGAgzCTHlEzLCFHMi41UjhreK4NVG6', '2016-10-14 17:04:57', '2016-10-26 21:56:28');
INSERT INTO `users` VALUES(6, 'Mesa 7', 0, 0, '', 'mesa7@mesa.com', '$2y$10$WYtg8Ps.uz57QH6zQlF4OewNSKdM6QazZ0gzN5EeVMcxFbJsom5JK', 'wna0PXYCFlC6Sx5Rst8D3KK4wUCFbOq0EgHgwGlezaF7mIzeEZFK8lj6IXWs', '2016-10-25 21:04:52', '2016-10-26 18:13:03');
...
ALTER TABLE `mesas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `mesas_email_unique` (`email`),
  ADD KEY `name` (`name`),
  ADD KEY `name_2` (`name`);
...
--
ALTER TABLE `pedidospostres`
  MODIFY `id_tabla` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
INSERT INTO `pma__relation` VALUES('restaurante', 'mesas', 'name', 'restaurante', 'pedidos', 'numero_mesa');
INSERT INTO `pma__relation` VALUES('restaurante', 'pedidos', 'numero_mesa', 'restaurante', 'mesas', 'name');
