...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-09-2016 a las 01:57:19
...
CREATE TABLE IF NOT EXISTS `pedidos` (
  ...
  KEY `numero_mesa_idx` (`numero_mesa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `pedidosbebidas` (
  ...
  `horab` time NOT NULL,
  PRIMARY KEY (`id_bebida`,`id_pedidob`),
  KEY `fk2pb_idx` (`id_pedidob`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `pedidoscomidas` (
  `id_plato` int(11) NOT NULL,
  `id_pedidoc` int(11) NOT NULL,
  `horac` time NOT NULL,
  PRIMARY KEY (`id_plato`,`id_pedidoc`),
  KEY `id_pedido_idx` (`id_pedidoc`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `pedidospostres` (
  `id_postre` int(11) NOT NULL,
  `id_pedidop` int(11) NOT NULL,
  `horap` time NOT NULL,
  PRIMARY KEY (`id_postre`,`id_pedidop`),
  KEY `fk1pp` (`id_pedidop`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
DROP VIEW IF EXISTS `pedidos_bebidas_comidas_postres`;
CREATE TABLE IF NOT EXISTS `pedidos_bebidas_comidas_postres` (
`num_factura` int(11)
,`mesa` int(11)
