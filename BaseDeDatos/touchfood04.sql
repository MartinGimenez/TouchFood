...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2016 a las 03:47:46
...
INSERT INTO `oferente` VALUES(1, 'la Estancia', 'admin1905', 'administrador');
INSERT INTO `oferente` VALUES(2, 'la Estancia', 'user1905', 'mozo');
...
INSERT INTO `pedidos` VALUES(4, 6, 'impago');
INSERT INTO `pedidos` VALUES(5, 6, 'impago');
INSERT INTO `pedidos` VALUES(6, 6, 'impago');
...
INSERT INTO `users` VALUES(5, 'Mesa 6', 6, 4, 'desocupada', 'mesa6@mesa6.com', '$2y$10$4qylSbICDc/zRcnNHDUh4Oe.tp/TQgjMTYnElHKbHaC6GeqXWv8A.', 'WC6VYf4t6XGIXbr00aZffF5BiaW82rBw4uw4bkmEGK3HMKHBidj3HJ9Guql7', '2016-10-14 17:04:57', '2016-10-14 19:05:06');

-- --------------------------------------------------------

--
-- Estructura para la vista de `pedidos_bebidas_comidas_postres` exportada como una tabla
--
DROP TABLE IF EXISTS `pedidos_bebidas_comidas_postres`;
CREATE TABLE`pedidos_bebidas_comidas_postres`(
    `num_factura` int(11) NOT NULL DEFAULT '0',
    `mesa` int(11) NOT NULL,
    `estado_factura` varchar(25) COLLATE utf8_general_ci NOT NULL,
