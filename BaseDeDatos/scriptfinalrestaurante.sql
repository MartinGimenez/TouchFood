...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-12-2016 a las 19:43:43
...
INSERT INTO `bebidas` VALUES(3, 'Coca-Colaa', 'agua/gas/colorantes/conservantes/etc', 'bebida-s-alcohol', 38, NULL, '00:05:00');
...
INSERT INTO `comidas` VALUES(130, 'Papas a lo Moe', 'papas moe', 'minutas', 121, 1, '15:02:00');
...
INSERT INTO `mesas` VALUES(1, 'Mesa 1', 'mesa1@mesas.com', '$2y$10$EZRqy.uQcXXUcI3TVCLIoe12bp3zi4sxULF0jVRiyRkfJbRyusrYK', '4', 'Desocupada', 'QfIOVgK6RtipImhwD8MSKW8JdhHnQgwIHFS1GfgbJRBWrFK1TvvqZu2P43ry', '2016-11-03 22:03:18', '2016-12-01 21:17:34', 1, 'cus_9fJHyUa9Tp5dOr', 'sub_9fJHTC0nQepZC7', 'semanal', '4242', NULL, NULL);
INSERT INTO `mesas` VALUES(2, 'Mesa 2', 'mesa2@mesas.com', '$2y$10$f2Ur0VYbVPyzMPTYq7I7FekvcXcjleErH.8gr5kLksaG.1zHCEJA6', '8', 'desocupada', 'OzjZjeNsaRAqgyGaJPGV2XN07gDeh8Bb5sqtauPqOOfXkKBXlQWomegOMMCW', '2016-11-03 22:04:30', '2016-11-22 00:29:05', 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `mesas` VALUES(3, 'Mesa 3', 'mesa3@mesas.com', '$2y$10$jhj47fGuLlHZPdb3aYr8keifh5FX5IYx.uB3JkoIw1ojb123DuSim', '4', 'Desocupada', 'UyAkEwekhWVwufDFcziW9glALWWw41Z7t5bA4kqJ6K93I29sQEZDtkmFeDCs', '2016-11-15 00:15:08', '2016-12-01 21:14:39', 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `mesas` VALUES(5, 'Mesa 4', 'mesa4@mesas.com', '$2y$10$i1OBUGyhq2Ci73imAQxAqOakEbe.P.SNk/QOh.zSaOPAJHKSUwe4m', '4', 'Desocupada', 'C4n7ft81gFZTS1bRZaj1Pnqt9olrMiA4ycq4bpopk6bka3b006rKC5iH9tqJ', '2016-12-01 21:08:42', '2016-12-01 21:14:55', 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `mesas` VALUES(6, 'Mesa 5', 'mesa5@mesas.com', '$2y$10$L8KBh4uuled1ylPdmeZWNOIH7fBakBNY1D.RvuepSlOEAN9/z.uu.', '2', 'Desocupada', 'RPXgAMLwtx5uh4HPStwLBInci0YCHH9qWAiGX4eOAzeDuHJkroZH9gJejsFC', '2016-12-01 21:09:21', '2016-12-01 21:15:05', 0, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `migrations` VALUES('2016_12_01_160528_add_cashier_columns', 4);
...
INSERT INTO `oferente` VALUES(1, 'Jhon Doe', 'mail@mail.com', '$2y$10$6OtzfvvUPaifq6Q2XVr4WeT6OdeI/MJInylaLnxxVfPlJhgukJR9W', '', 'Z4pum9kL6dnNjnWVaXrs1kPMj18sUhF4POUxmnQLTgg9KMaatdoLEZbtah39', '0000-00-00 00:00:00', '2016-12-01 03:43:25');
INSERT INTO `oferente` VALUES(2, 'admin', 'admin@admin.com', '$2y$10$Zisdx0ZBPuTqAuGRb5YPOukykOgX2NodVsCt0uIU3Q4aHpn4WTyLG', '', 'djm4SlhxhPmCGnqyAW8OEMGJhwU1KA3eCHuGj7Yc4tn6b47KDZSAaEOV1OsK', '2016-11-03 05:46:40', '2016-11-04 03:13:11');
...
INSERT INTO `pedidos` VALUES(110, 'Mesa 1', 'impago');
...
INSERT INTO `postres` VALUES(2, 'bocha helado vainilla', 'vainilla', 'postres', 33, NULL, '00:07:00');
...
--
ALTER TABLE `bebidas`
  MODIFY `id_bebida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
-- AUTO_INCREMENT de la tabla `comidas`
--
ALTER TABLE `comidas`
  MODIFY `id_plato` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;
--
...
--
ALTER TABLE `pedidos`
  MODIFY `id_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
--
...
--
ALTER TABLE `postres`
  MODIFY `id_postre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
