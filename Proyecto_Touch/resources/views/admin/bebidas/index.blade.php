...
<div class="card-panel black-text">
			<table class="striped centered black-text">
			    ...
			    <tbody>
			    	@foreach($categorias_bebidas as $categoria_bebida)
			      	<tr>
			        	<td class="agrandarletra">{{ ucwords($categoria_bebida->categoria) }}</td>
			        	<form method="POST" action="{{ route('bebidas.listado') }}">
              			{!! csrf_field() !!}
              			<input type="hidden" name="categoria" value="{{$categoria_bebida->categoria}}">	
