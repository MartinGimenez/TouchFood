...
class CategoriasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.menu.categorias.categorias')->with('categorias_comidas',$categorias_comidas)->with('categorias_postres',$categorias_postres)->with('categorias_bebidas',$categorias_bebidas);
